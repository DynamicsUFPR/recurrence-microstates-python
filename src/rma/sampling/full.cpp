...
#include "../sampling.h"
//  ------------------------------------------------------------------------------------------------------------------
Full::Full(const py::buffer_info &x, const py::buffer_info &y, const std::unique_ptr<IShape> &shape, const std::vector<int> &structure) : ISampling(x, y, shape, structure) {
